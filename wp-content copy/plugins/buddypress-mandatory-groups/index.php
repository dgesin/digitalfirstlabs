...
Requires at least: WP 3.0, BuddyPress 1.6
Tested up to: WP 3.6-beta1 , BuddyPress 1.7-RC-1
...
define ( 'BP_MANDATORY_GROUPS_VERSION', '1.3' );
...
function bp_mandatory_groups_setup_globals() {
	...
	$bp->mandatory_groups = new stdClass();
